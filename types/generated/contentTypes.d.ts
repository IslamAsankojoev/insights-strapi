...
export interface ApiAccountAccount extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    name: Schema.Attribute.String & Schema.Attribute.Required;
    ad_account_id: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiCurrentAccountCurrentAccount
  extends Struct.SingleTypeSchema {
  collectionName: 'current_accounts';
  info: {
    singularName: 'current-account';
    pluralName: 'current-accounts';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::current-account.current-account'
    >;
  };
}

export interface ApiTelegrammChatIdTelegrammChatId
  extends Struct.CollectionTypeSchema {
  collectionName: 'telegramm_chat_ids';
  info: {
    singularName: 'telegramm-chat-id';
    pluralName: 'telegramm-chat-ids';
    displayName: 'Telegramm Chat Ids';
  };
  options: {
    draftAndPublish: true;
  };
